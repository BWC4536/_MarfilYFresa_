...
## Agentes y Flujo de Trabajo (2026-04-16)

**Agente 1 – Frontend Rockstar**
- Experto en interfaces de tiendas premium (inspirado en Nike).
- Implementa diseños modernos, animaciones, flujos de reserva intuitivos y experiencia de usuario de alto nivel. Sin pasarelas de pago: el checkout gestiona la reserva para pago manual posterior.

**Agente 2 – Backend Maestro**
- Especialista en bases de datos, APIs y lógica de negocio.
- Garantiza integridad, rendimiento y seguridad de los datos.

**Agente 3 – Tester de Calidad**
- Verifica funcionalidad al 100 %: pruebas de UI, flujos de compra, accesibilidad y vulnerabilidades.
- Reporta fallos y sugiere mejoras al Frontend o Backend.

### Flujo de Trabajo Iterativo
1. **Planificación** – Frontend y Backend reciben la especificación del feature o mejora.
2. **Desarrollo** – Ambos agentes implementan sus partes de forma paralela.
3. **Testing** – El Tester ejecuta pruebas automatizadas y manuales, revisa seguridad y usabilidad.
4. **Feedback** – Si el Tester detecta problemas, crea tickets claros para Frontend o Backend.
5. **Corrección** – Los agentes corrigen los issues y notifican al Tester.
6. **Re‑test** – El Tester vuelve a validar hasta que todo esté perfecto.
7. **Entrega** – Cuando el Tester aprueba, el feature se marca como completado y se despliega.

Este ciclo se repite para cada tarea, asegurando calidad premium y mejoras continuas.
