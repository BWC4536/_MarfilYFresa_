      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex min-h-[90vh] flex-col items-center justify-center text-center">
          ...
          <button
            ...
            className="mt-10 inline-flex items-center justify-center rounded-full bg-terracota px-8 py-4 text-base font-medium text-white transition-all hover:bg-brown hover:scale-105 focus:outline-none focus:ring-2 focus:ring-brown focus:ring-offset-2 focus:ring-offset-cream"
          >
            Ver colección
          </button>
        </div>
